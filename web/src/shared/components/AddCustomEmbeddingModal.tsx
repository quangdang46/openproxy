...
interface AddCustomEmbeddingModalNode {
  id?: string;
  name?: string;
  prefix?: string;
  baseUrl?: string;
...
interface AddCustomEmbeddingModalProps {
  isOpen: boolean;
  onClose: () => void;
  onCreated?: (node: AddCustomEmbeddingModalNode) => void;
  onSaved?: (node: AddCustomEmbeddingModalNode) => void;
  node?: AddCustomEmbeddingModalNode;
}
