...
function sortData(dataMap: Record<string, any>, pendingMap: Record<string, number> = {}, sortBy: string, sortOrder: string) {
...
function getGroupKey(item: any, keyField: string): string {
  switch (keyField) {
