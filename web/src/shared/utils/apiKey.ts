 ...
 * @returns API key and keyId
 */
export function generateApiKeyWithMachine(machineId: string): ApiKeyResult {
 ...
 * - Old: sk-{random8}
 * @param apiKey
 * @returns Parsed API key data or null
 */
export function parseApiKey(apiKey: string | null | undefined): ParsedApiKey | null {
