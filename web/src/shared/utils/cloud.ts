...
export function getCloudUrl(machineId: string): string {
...
export async function callCloudWithMachineId(request: Request): Promise<Response> {
...
export function startProviderSync(cloudUrl: string, intervalMs: number = 900000): null { // Default 15 minutes
