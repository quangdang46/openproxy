...
const isLocalhostUrl = (url: string): boolean => /localhost|127\.0\.0\.1|0\.0\.0\.0/i.test(url || "");
      ...
      <div className="flex items-start justify-between gap-3 hover:cursor-pointer sm:items-center" onClick={onToggle}>
        <div className="flex min-w-0 items-center gap-3">
          <div className="size-8 flex items-center justify-center shrink-0">
            <img src={tool.image} alt={tool.name} width={32} height={32} className="size-8 object-contain rounded-lg" sizes="32px" onError={(e: React.SyntheticEvent<HTMLImageElement>) => { (e.target as HTMLImageElement).style.display = "none"; }} />
          </div>
            ...
            <>
              <div className="flex flex-col gap-2">
                ...
                <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-[8rem_auto_1fr_auto] sm:items-center sm:gap-2">
                  ...
                  <select
                    value={endpointMode}
                    onChange={(e: ChangeEvent<HTMLSelectElement>) => handleEndpointModeChange(e.target.value)}
                ...
                <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-[8rem_auto_1fr_auto] sm:items-center sm:gap-2">
                  ...
                  <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setCustomBaseUrl(stripV1(e.target.value))}
