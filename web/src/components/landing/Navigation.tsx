    ...
    <nav className="fixed top-0 z-50 w-full bg-[#181411]/80 backdrop-blur-md border-b border-[#3a2f27]">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          {/* <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors" href="https://github.com/decolua/openproxy#readme" target="_blank" rel="noopener noreferrer">Docs</a> */}
          {/* <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors flex items-center gap-1" href="https://github.com/decolua/openproxy" target="_blank" rel="noopener noreferrer">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-[#3a2f27] bg-[#181411]/95 backdrop-blur-md">
          <div className="flex flex-col gap-4 p-6">
            ...
            {/* <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors" href="https://github.com/decolua/openproxy#readme" target="_blank" rel="noopener noreferrer">Docs</a> */}
            {/* <a className="text-gray-300 hover:text-white text-sm font-medium transition-colors" href="https://github.com/decolua/openproxy" target="_blank" rel="noopener noreferrer">GitHub</a> */}
            <button
              onClick={() => window.location.href = "/dashboard"}
