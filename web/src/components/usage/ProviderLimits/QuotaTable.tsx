...
interface QuotaTableProps {
  ...
  onHideQuota?: ((quota: Quota) => void) | null;
}
...
function sortQuotas(quotas: Array<Quota & { remaining: number }>, sortMode: string) {
 ...
 * Ported from 9router QuotaTable.js: sort mode, pagination (10/page),
 * per-row hide action, unlimited rows.
 */
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="space-y-px">
        {currentPageRows.map((quota, rowIndex) => {
          ...
          <div className="flex items-center justify-between gap-2 text-[10px] text-text-muted">
            ...
            <div className="flex items-center gap-1">
              <button
                ...
                className="rounded px-1.5 py-0.5 transition-colors hover:bg-black/5 disabled:opacity-30 dark:hover:bg-white/5"
              >
                Prev
              </button>
              <span>
