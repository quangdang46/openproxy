...
use crate::core::translator::registry::{CursorResponseState, ResponseTransformState};
...
pub fn cursor_to_openai_streaming(chunk: &[u8], state: &mut ResponseTransformState) -> Vec<String> {
